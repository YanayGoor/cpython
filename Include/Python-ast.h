...
enum _expr_kind {BoolOp_kind=1, BinOp_kind=2, Pyx_kind=3, UnaryOp_kind=4,
...
expr_ty _Py_BinOp(expr_ty left, operator_ty op, expr_ty right, int lineno, int
                  col_offset, PyArena *arena);
#define Pyx(a0, a1, a2, a3) _Py_Pyx(a0, a1, a2, a3)
expr_ty _Py_Pyx(string name, int lineno, int col_offset, PyArena *arena);
